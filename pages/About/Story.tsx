    ...
    <div className="max-w-4xl mx-auto px-4 py-10 text-gray-800">
      ...
      <p className="mb-4">
        <Link href="https://www.linkedin.com/in/arunprakashsharma/" target="_blank">
          <strong className="text-blue-600 hover:underline">Arun Prakash Sharma</strong>
        </Link>, a seasoned trainer and expert in project management, has experienced both triumphs and failures throughout his journey. These failures weren’t setbacks—they were lessons. At AltP3, we embrace this philosophy: <strong>learning from real-world mistakes is the key to mastering project management.</strong>
      </p>
      <p className="mb-4">
